...
public class seachs extends  Activity {
...
//			}
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        seachname=(EditText) findViewById(R.id.editText1);
        f_doujinshi=(CheckBox)findViewById(R.id.doujinshi);
        f_manga=(CheckBox)findViewById(R.id.manga);
        f_gamecg=(CheckBox)findViewById(R.id.gamecg);
        f_western=(CheckBox)findViewById(R.id.westrn);
        f_non_h=(CheckBox)findViewById(R.id.non_h);
        f_imageset=(CheckBox)findViewById(R.id.imageset);
        f_cosplay=(CheckBox)findViewById(R.id.cosplay);
        f_asianporn=(CheckBox)findViewById(R.id.asianporn);
        f_misc=(CheckBox)findViewById(R.id.misc);
        f_artistcg=(CheckBox)findViewById(R.id.artistcg);
