package dm.book.rulethirtyfour;//package cool.dm.ehbrowser;
...
//        View v = fragmentView.findViewById(R.id.prviewpage);//找到你要?透明背景的layout 的id
//        v.getBackground().setAlpha(0);//透明度0~255透明度值 ，值越小越透明
//        View v2 = fragmentView.findViewById(R.id.nextpage);//找到你要?透明背景的layout 的id
