...
public class staadd extends Activity {
    int e=0;
    int Mon;
    int Day;
    int Min;
    ...
    private Button.OnClickListener deleteButtonOnClickListener
        ...
        public void onClick(View v) {
            AlertDialog.Builder builder = new AlertDialog.Builder(staadd.this);
            ...
            builder.setPositiveButton(R.string.str_rely,
                    new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            new AlertDialog.Builder(staadd.this)
            ...
            builder.setNegativeButton(R.string.str_cancel,
                    new DialogInterface.OnClickListener()
                    {
                        ...
                        public void onClick(DialogInterface dialog, int which)
                        {
                            ...
                            Toast.makeText(staadd.this, R.string.str_cancel,
    ...
    private Button.OnClickListener whereButtonOnClickListener
        ...
        @Override
        public void onClick(View v) {
            LayoutInflater inflater = LayoutInflater.from(staadd.this);
    ...
    private void time(){
        ...
        PendingIntent pi = PendingIntent.getBroadcast(staadd.this, 1, intent, 0);
