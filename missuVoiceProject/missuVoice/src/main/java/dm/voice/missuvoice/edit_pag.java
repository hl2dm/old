 ...
 */
public class edit_pag extends Activity {
    String folodname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next_btn.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                if(talk1+talk2+talk3+talk4!=4){
                    Toast.makeText(edit_pag.this, "此項步驟你還沒完成喔", Toast.LENGTH_SHORT).show();
                }else {
                taf.setClass(edit_pag.this, teachactivityf.class);
                startActivity(taf);
                finish();
                }
            }
        ...
        back_btn.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                taf.setClass(edit_pag.this, teachactivity2.class);
                startActivity(taf);
                finish();
            }
