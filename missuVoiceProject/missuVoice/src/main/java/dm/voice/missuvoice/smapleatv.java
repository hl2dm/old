...
public class smapleatv extends Activity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showface.setImageResource(R.drawable.google_lady);
        tts = new TextToSpeech(this, this);
//        tvText = (TextView) findViewById(R.id.textView);
        soundPool = new SoundPool(1, AudioManager.STREAM_MUSIC, 5);
        s[0] = soundPool.load(this,R.raw.hellos, 0);
        s[1] = soundPool.load(this,R.raw.moonn, 0);
        s[2] = soundPool.load(this,R.raw.avto, 0);
        s[3] = soundPool.load(this,R.raw.gn, 0);
        s[4] = soundPool.load(this,R.raw.wtf, 0);
    }
