...
import dm.book.rulethirtyfour.browseData_blob.DBOpenHelper;
import dm.book.rulethirtyfour.browseData_blob.Site;
...
String seachname;
	...
	public Viewpage3(String[] pagelink2, int pagl) {
		this.link=pagelink2;
		this.paglink=pagl;
	}
